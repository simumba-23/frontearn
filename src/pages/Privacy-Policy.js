            ...
            <Card className="p-4">
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <ul>
                    <li><strong>Personal Data:</strong> While using our Site, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to:
                      <ul>
                        <li>Name</li>
                        <li>Email address</li>
                        <li>Phone number</li>
                ...
                <Card.Text>
                  ...
                  <ul>
                    ...
                    <li>Send you confirmations and alerts</li>
                    <li>Provide customer support</li>
                    <li>Improve the Site and develop new products and services</li>
                ...
                <Card.Text>
                  Our Site may contain links to third-party websites and services that are not owned or controlled by us. We are not responsible for the content or privacy practices of any third-party websites. We encourage you to review the privacy policy of any website you visit.
                </Card.Text>
                
                <h2>7. Your Choices</h2>
                <Card.Text>
                  You may review, update, or delete your personal information by logging into your account and updating your settings. You can also contact us to request access to, correct, or delete any personal information that you have provided to us.
                </Card.Text>
