...
import { Row, Col, Alert, Card, CardBody, CardText, Form } from 'react-bootstrap';
            ...
            {filteredTasks.length > 0 ? (
                <>
                    ...
                    {filteredTasks.map((task) => (
                        <Row key={task.id} className="mb-4 task-row">
                            <Col>
                                <Card className='task-card' onClick={() => handleSelectTask(task)}>
                                    <CardBody>
                                        <Row>
                                            ...
                                            <Col md={6} className='d-flex flex-column justify-content-center'>
                                                <CardText as="h5" className="task-title">{task.name}</CardText>
                                                <CardText><GiTwoCoins />  {task.points} points </CardText>
                                            </Col>
                                        </Row>
                                    </CardBody>
                                </Card>
