...
import {
  Button, Dropdown, DropdownButton, FormControl, InputGroup, Row, Col, Table, Spinner, Alert,
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        ...
        setData(response.data.display_active_users);
      } catch (error) {
